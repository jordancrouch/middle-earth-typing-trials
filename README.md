...
- [HTML Validator](https://www.htmlvalidator.com)
  - The HTML Validator was used to validate HTML, CSS, and JavaScript. This validator was used as it includes newer HTML attributes used (such as popover) and includes CSS rules that are used in Tailwind CSS.
