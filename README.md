...
Once quotes are fetched, they are processed so each letter and word is individually wrapped in a HTML element. From here, classes can be applied based on the user's input, providing feedback on correctly or incorrectly typed characters.
